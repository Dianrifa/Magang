    ...
    <div class="box">
        ...
        <form method="post" name="proses">
            ...
            <table class="table table-striped table-bordered table-hover" id="Witel">
                ...
                <?php
				    $no = 1 ;
					$sql = mysqli_query($con, "SELECT * FROM tb_target_minipack_kelas_a") or die (mysqli_eror($con));
        ...
        <h4>
            ...
            <table class="table table-striped table-bordered table-hover" id="Witel2">
                ...
                <?php
				    $no = 1 ;
					$sql = mysqli_query($con, "SELECT * FROM tb_target_stbtambahan_kelas_a") or die (mysqli_eror($con));
					while($data = mysqli_fetch_array($sql)){ ?>
                    <tr>
                        <td align="center">
						    <input type="checkbox" name="checked[]" class="check"value="<?=$data['Witel']?>">
        ...
        <h4>
            ...
            <table class="table table-striped table-bordered table-hover" id="Witel3">
                ...
                <?php
				    $no = 1 ;
					$sql = mysqli_query($con, "SELECT * FROM tb_target_upgradespeed_kelas_a") or die (mysqli_eror($con));
					while($data = mysqli_fetch_array($sql)){ ?>
                    <tr>
                        <td align="center">
						    <input type="checkbox" name="checked[]" class="check"value="<?=$data['Witel']?>">
        ...
        <h4>
            ...
            <table class="table table-striped table-bordered table-hover" id="Witel4">
                ...
                <?php
				    $no = 1 ;
					$sql = mysqli_query($con, "SELECT * FROM tb_target_migrasi2pto3p_kelas_a") or die (mysqli_eror($con));
					while($data = mysqli_fetch_array($sql)){ ?>
                    <tr>
                        <td align="center">
						    <input type="checkbox" name="checked[]" class="check"value="<?=$data['Witel']?>">
        ...
        <h4>
            ...
            <table class="table table-striped table-bordered table-hover" id="Witel5">
                ...
                <?php
				    $no = 1 ;
					$sql = mysqli_query($con, "SELECT * FROM tb_target_migrasi1pto2p_kelas_a") or die (mysqli_eror($con));
					while($data = mysqli_fetch_array($sql)){ ?>
                    <tr>
                        <td align="center">
						    <input type="checkbox" name="checked[]" class="check"value="<?=$data['Witel']?>">
        ...
        <h4>
            ...
            <table class="table table-striped table-bordered table-hover" id="Witel6">
                ...
                <?php
				    $no = 1 ;
					$sql = mysqli_query($con, "SELECT * FROM tb_target_ott_kelas_a") or die (mysqli_eror($con));
					while($data = mysqli_fetch_array($sql)){ ?>
                    <tr>
                        <td align="center">
						    <input type="checkbox" name="checked[]" class="check"value="<?=$data['Witel']?>">
