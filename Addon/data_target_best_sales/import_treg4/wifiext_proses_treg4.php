...
if(isset($_POST['import'])){
    ...
    if(isset($_FILES['file']['name']) && in_array($_FILES['file']['type'], $file_mimes)) {
        ...
        for($i = 1;$i < count($sheetData);$i++)
        {
            ...
            mysqli_query($koneksi,"INSERT INTO tb_target_wifiext_treg4(nomor,Witel,Januari,Febuari,Maret,April,Mei,Juni,Juli,Agustus,September,Oktober,November,Desember,FY_2021) values ('$no','$witel','$januari','$februari','$maret','$april','$mei','$juni','$juli','$agustus','$september','$oktober','$november','$desember','$FY_2021')");
        }
